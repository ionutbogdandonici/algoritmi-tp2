...
class KruskalMSPTest {
    ...
    final void exceptionsTest(){
        ...
        gr.addEdge(new GraphEdge<String>(h, i, false, 7));
        KruskalMSP<String> alg = new KruskalMSP<String>();
        // Ho preso il testComputeMSP come esempio per i test, modificando alcuni valori per i test sulle Exceprions
    ...
    // Per questo test ho preso il grafo testFindMSP2 del file PrimMSPTest.java
    @Test
    final void testFindMSP2(){
        ...
        toCheck.add(new GraphEdge<String>(a, b, false, 1));
        toCheck.add(new GraphEdge<String>(b, c, false, 3));
        toCheck.add(new GraphEdge<String>(b, d, false, 2));
        assertEquals(toCheck, alg.computeMSP(gr));
    }
}
